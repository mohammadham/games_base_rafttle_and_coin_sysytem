...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'رمز عبور وارد شده در نشت داده‌ها ظاهر شده است. لطفاً رمز عبور دیگری انتخاب کنید.',
    ],
    ...
    'required_without_all' => 'فیلد :attribute هنگامی که هیچکدام از :values موجود نیستند الزامی است.',
