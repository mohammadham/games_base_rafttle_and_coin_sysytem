...
@section('content')
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card custom--card">
                    <div class="card-header card--header d-flex flex-wrap justify-content-between align-items-center gap-2">
                    ...
                    <div class="card-body">
                        <form method="post" class="disableSubmission" action="{{ route('ticket.reply', $myTicket->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="row justify-content-between">
                                ...
                                <div class="col-md-9">
                                    <button type="button" class="btn btn--dark btn--md addAttachment my-2"> <i class="fas fa-plus"></i> @lang('Add Attachment') </button>
    ...
    <x-confirmation-modal customModal="custom--modal" closeBtn="btn btn--dark btn--md" submitBtn="btn btn--base btn--md" />
@endsection
