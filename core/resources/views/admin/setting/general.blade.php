                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="form-group ">
                                    <label> @lang('Cart Automatic Remove Duration')</label>
                                    <div class="input-group">
                                        <input class="form-control" type="number" name="cart_duration" required value="{{ gs('cart_duration') }}">
                                        <div class="input-group-text">@lang('Minute')</div>
                                    </div>
                                </div>
                            </div>
                        </div>
