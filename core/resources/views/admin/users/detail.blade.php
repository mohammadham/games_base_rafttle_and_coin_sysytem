    ...
    <div class="row">
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.winners.user.detail', $user->id) }}" title="Winning Tickets" icon="las la-trophy" value="{{ $totalWins }}" bg="11" type="2" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.sold.tickets') }}?search={{ $user->username }}" title="Lottery Buy" icon="las la-ticket-alt" value="{{ $totalPurchased }}" bg="6" type="2" />
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('Verified')" data-off="@lang('Unverified')" name="ev"
                            ...
                            <div class="col-xl-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('Verified')" data-off="@lang('Unverified')" name="sv"
