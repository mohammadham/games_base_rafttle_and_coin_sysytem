...
class AdminController extends Controller {
    ...
    public function dashboard() {
        ...
        $competition['type']    = Competition::count();
        $competition['lottery'] = Lottery::count();
        $competition['winner']  = Lottery::drawn()->count();

        return view('admin.dashboard', compact('pageTitle', 'widget', 'chart', 'deposit', 'competition'));
    }
